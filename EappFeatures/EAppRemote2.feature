...
And Select Military on Eligibility Option, Navy on Branch of Service, Retiree status, 
...
And Click Review Application on AFBA Enrollment 
...
And Input Sponsor and spouse Last Name and last four SSN numbers
