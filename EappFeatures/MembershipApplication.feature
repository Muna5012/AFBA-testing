@membershipApplicationverify
Feature: New Membership Application Sponsor With adult child to select BA, FedTerm, First protect and Group Free products to select yes or no test feature 
Scenario: New Membership Application Sponsor With adult child to select BA, FedTerm, First protect and Group Free products to select yes or no test scenario
...
And Select BA Tobacco for sponsor and Customize one hundred thousand K
Then Select FedTerm Customize Sponsor and No customize for adult child
And Select First Protect customize sdult child 
...
And Input Sponsor BA Contingent Beneficiary coverage full name, SSN, relationship and DOB
Then Input FetTerm product Sponsor Primary Beneficiary full name, SSN, relationship, DOB
And Input FedTerm Product Sponsor Contingent Beneficiary full name, SSN, relationship and DOB
