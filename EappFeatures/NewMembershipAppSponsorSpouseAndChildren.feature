...
And click Begin Enrollement buttonInput Sponsor First Name, Last Name, Gender and DOB
Then Click Married to input Spouse First Name, Last Name and DOB
And Click Include Children Button to input Adult Child First Name, Last Name, DOB
...
Then Select Military Allotment on Contribution Mode and input Department Code AutoTest and Source Code AT1
...
And Select BA Customize sponsor spouse, and select child coverage 
Then Click Fed Term, Tobacco to sponsor, Cutomize sponsor and spouse, no benefit to two kids
And Click First Protect Customize two adult child, no benefit to sponsor and spouse
...
And Input BA Spouse Primary Beneficiary full name, DOB, SSN, relationship
And Input Fed Term Sponsor Primary Beneficiary full name, SSN, relationship, DOB
...
And Input First Protect second kid primary beneficiary full name, SSN, relationship, DOB
...
And Click I Sgree to This Coverage and am ready to signin button
