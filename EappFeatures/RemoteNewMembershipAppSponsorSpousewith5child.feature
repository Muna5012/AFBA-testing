...
And Select FedTerm customize sponsor, spouse and adult child
Then Waive the Senior Protect
And Covered Application Member Benefit and select Yes or NO
Then Select First Protect customize adult and minor kids
And Select Childrens Protect and Covered children
