@Test12
Feature: Flash message functionality on the contact and portfolio records ninth Test Environment

Scenario: Flash message functionality Test Environment Feature ninth test Scenario
