@Test04
Feature: Flash message functionality on the contact and portfolio records Test Environment

Scenario: Flash message functionality Test Environment Feature test Scenario
...
And scroll down to Select Client IDs
