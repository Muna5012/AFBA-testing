...
Scenario: Beneficiary Change Request Feature test Scenario

When Click New request button
Then Go throgh all the Steps on Instructions click Next button
And On Step two select policy Numbers
Then Able to click Next button
And On Primary Beneficiaries click Add Primary button
...
And Input Percentage Numbers
Then Input Address Line
And Input City name
Then Input State name
And Input Zip Code Number
