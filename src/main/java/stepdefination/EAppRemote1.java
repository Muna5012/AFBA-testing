...
public class EAppRemote1 extends TestBase{
   ...
   // Remote.BeginEnrollment.click();
	...
	public void input_Sponsor_First_Name_Last_Name_Gender_DOB() {
	    Remote.FirstName.sendKeys("Yolanda");
	    Remote.LastName.sendKeys("Adams Belltran");
	    Remote.DOB.click();
	    act.pause(1000).perform();
	    Remote.DOB.sendKeys("10161969");
	    Remote.Gender.click();   
	    act.pause(2000).perform();
	}
	...
	public void click_Married_radio_button_and_Input_spouse_information() {
	    ...
	    Remote.SpouseLN.sendKeys("Belltran");
	...
	@Then("Better Alternative select Tobacco for spouse and Customise fifty thousand K for Sponsor and Spouse")
	public void better_Alternative_select_Tobacco_for_spouse_and_Customise_fifty_thousand_K_for_Sponsor_and_Spouse() {
	...
	@Then("Waived Fed Term Product and Application Member Benefit five thousand K")
	public void waived_Fed_Term_Product_and_Application_Member_Benefit_five_thousand_K() {
	...
	@Then("Senior Protect select Option three")
	public void senior_Protect_select_Option_three() {
	   Remote.SeniorProtect.click();
	   Remote.SeniorProtectOption3.click();
	   act.pause(2000).perform();	   
	}

	@Then("First Protect Customize sponsor fifty thousand K and spouse fifty thousand K")
	public void first_Protect_Customize_sponsor_fifty_thousand_K_and_spouse_fifty_thousand_K() {
...
//	    Remote.FirstProtectSpouse7.click();
	...
	public void input_Sponsor_Last_Name_and_last_four_SSN_numbers() {
		Remote.SponsorLastName.sendKeys("Adams Bellt");
		Remote.verifySSN.click();
	    act.pause(2000).perform();
	    Remote.SponsorLastName.clear();
		Remote.SponsorLastName.click();	
	    Remote.SponsorLastName.sendKeys("Adams Belltran");
