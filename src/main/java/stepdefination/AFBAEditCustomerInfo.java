...
public class AFBAEditCustomerInfo extends TestBase {
	...
	public void get_Text_of_Edit_Contact_Information() {
		String str = AFBACustomerPortalMainPage.GetTextOfEditContactInformation.getText();
...
//		action.moveToElement(AFBACustomerPortalMainPage.ClickCheckBoxforTextAlert).build().perform();
	...
	public void select_each_alert_you_want_to_receive() {
		AFBACustomerPortalMainPage.ClickFirst.click();
		AFBACustomerPortalMainPage.ClickSecond.click();
		AFBACustomerPortalMainPage.ClickThrid.click();
		act.pause(1000).perform();
	}
