...
public class ClaimsIntake3  extends TestBase{
	...
	public void step_three_Input_Insured_FN_LN_DOB_DOD_Nature_of_Death_Cause_of_Death() {
		...
		ClaimsIntake.DOB.sendKeys("01011999");
		act.pause(4000).perform();
		ClaimsIntake.DOD.click();
		ClaimsIntake.DOD.sendKeys("12042012");
		act.pause(4000).perform();
	...
	@Then("Select Outside of US, Country where death occurred, Policy Num, SSN")
	public void select_Outside_of_US_Country_where_death_occurred_Policy_Num_SSN() {
		...
		ClaimsIntake.InsuredCompleteSSN.sendKeys("123456789");
	...
	public void select_add_another_Ex_Spouse_input_Ex_Spouse_FN_LN_Date_of_Second_Divorce_Date_of_Death() {
		...
		act.pause(3000).perform();
		ClaimsIntake.SecondXSpouseFN.click();
		ClaimsIntake.SecondXSpouseFN.sendKeys("Molly");
		act.pause(3000).perform();
		ClaimsIntake.SecondXSpouseLn.click();
