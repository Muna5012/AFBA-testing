...
public class ClaimsIntake1 extends TestBase{
	...
	public void input_Email_Address_City_State_ZipCode_country_and_Phone_number() {
		...
		ClaimsIntake.Email.sendKeys("mababaikeli@afba.com");
		act.pause(5000).perform();
...
//	ClaimsIntake.PolicyNum.sendKeys("123456");
	...
	ClaimsIntake.InsuredCompleteSSN.sendKeys("987654321");
	act.pause(5000).perform();
...
public void input_Spouse_FN_LN_DOB_SSN_and_click_Next_button() {
	ClaimsIntake.SpouseFN.click();
	ClaimsIntake.SpouseFN.sendKeys("Thoms");
	act.pause(5000).perform();
	ClaimsIntake.SpouseLN.click();
	ClaimsIntake.SpouseLN.sendKeys("Johnny");
	act.pause(5000).perform();
		...
		act.pause(5000).perform();
		ClaimsIntake.SpouseStreetAddress.click();
		ClaimsIntake.SpouseStreetAddress.sendKeys("5478 2nd st");
		act.pause(5000).perform();
		ClaimsIntake.SpouseCity.sendKeys("Falls Church");
		act.pause(5000).perform();
		ClaimsIntake.SpouseState.click();
		ClaimsIntake.VAState.click();
		act.pause(5000).perform();
		ClaimsIntake.SpouseZipCode.click();
		ClaimsIntake.SpouseZipCode.sendKeys("22046");
		ClaimsIntake.SpouseCountry.click();
		ClaimsIntake.USCountry.click();
		act.pause(5000).perform();
		ClaimsIntake.SpousePhoneNum.sendKeys("7032365998");
		act.pause(5000).perform();
		ClaimsIntake.SpouseEmail.sendKeys("qapeep19@gmail.com");
		act.pause(5000).perform();
