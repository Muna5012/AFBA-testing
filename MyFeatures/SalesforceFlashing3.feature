@Test06
Feature: Flash message functionality on the contact and portfolio records thrird Test Environment

Scenario: Flash message functionality Test Environment Feature third test Scenario
...
And scroll down to Select Client ID
