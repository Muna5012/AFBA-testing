@Test05
Feature: Flash message functionality on the contact and portfolio records second Test Environment

Scenario: Flash message functionality Test Environment Feature second test Scenario
