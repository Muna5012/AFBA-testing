@EAppProductionIssue1
Feature: EApp production issue for fill out whole process Test feature 
Scenario: EApp production issue for fill out whole process Test scenario
...
And Enter Street address, City, State, Zipcode
Then Enter Email address and repeat Email address for confirmatin and Enter Daytime Phone numbers
And Click Show Coverage Options button to select the benefit plan
Then Select BA and customize 
And Select Application Member Benefit Covered and vaived Fed Term and First Protect
Then Answer all the questions which include other Insuarance 
And Select sponsor Height and Weight
Then Enter Sponsor Better Alternative Primary Beneficiary full name, SSN, relationship and DOB
And Enter Sponsor Better Alternative Contingent Beneficiary full name, SSN, relationship and DOB
Then Enter Sponsor Application Member Benefit primary beneficiary full name, SSN, Relationship and DOB
And Enter Sponsor Application Member Benefit contingent beneficiary full name, SSN, Relationship and DOB
Then Select Acknowledgement of Military Allotment Method of Payment
And Click Sigining in Person button and click Agree to this coverage and ready to sign button
...
And Enter Email Address and click Show Coverage Options
Then Select BA and Coverage, Covered Application Member, Waived Fed Term, and FirstProtect
And Answer all the questions Yes or No
Then Select Sponsor SSN and change it
And Enter Sponsor BA primary Beneficiary full name, SSN, Relationship and DOB
Then Enter Sponsor Contingent Beneficiary full name, SSN, Relationship and DOB 
And Enter Sponsor Application Member Benefit primary Beneficiary full name, SSN, Relationship and DOB
...
And click Agree to this coverage sign button
