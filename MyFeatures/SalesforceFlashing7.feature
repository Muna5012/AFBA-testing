@Test10
Feature: Flash message functionality on the contact and portfolio records seventh Test Environment

Scenario: Flash message functionality Test Environment Feature seventh test Scenario
