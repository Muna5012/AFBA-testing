...
And click Begin Enrollement and Input Sponsor FirstName, LastName, Gender and DOB
Then Click Married button to Input spouse FirstName,LastName and DOB
And Click Include Children button to input first Child FirstName, LastName, DOB
And Click Add Child button to input second Child FirstName, LastName, DOB
And Click Add Child button to input third Child FirstName, LastName, DOB
...
And Next page input Spouse Information
