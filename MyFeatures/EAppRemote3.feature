...
And Select Law Enforcement on Eligibility, select Credit Card on Contribution Mode 
Then Enter Street Address, City, State and Zip
And Enter Email address, Daytime Phone Numbers
Then Click Show Coverage Option to select sponsor and spouse Beneficiary Plans
And Better Alternative select Tobacco for Spouse and Customize fifty thousand K for Sponsor and Spouse
Then Waived Fed Term and Application Member Benefit Products
And Senior Protect select Option One 
Then First Protect Customize one hundred K for sponsor and spouse
And Next page for Qualification Answer all the questions
Then Enter Sponsor Information Height Feet, Inches and Weight 
And Enter Spouse Information SSN, Gender, Height feet inches and Weight

Then Input Beneficiaries for Better Alternative Sponsor Primary Beneficiary FullName, Relationship and DOB
And Input Beneficiaries for Better Alternative Sponsor Contingent Beneficiary FullName, Relationship and DOB
Then Input Beneficiaries for Better Alternative Spouse Primary Beneficiary FullName, Relationship and DOB
And Input Beneficiaries for Better Alternative Spouse Contingent Beneficiary FullName, Relationship and DOB

Then Input Beneficiaries for Senior Protect Sponsor Primary Beneficiary FullName, Relationship and DOB 
And Input Beneficiaries for Senior Protect Sponsor Contingent Beneficiary FullName, Relationship and DOB
Then Input Beneficiaries for Senior Protect Spouse Primary Beneficiary FullName, Relationship and DOB
And Input Beneficiaries for Senior Protect Spouse Contingent Beneficiary FullName, Relationship and DOB

Then Input Beneficiaries for First Protect Sponsor Primary Beneficiary FullName, Relationship and DOB
And Input Beneficiaries for First Protect Sponsor Contingent Beneficiary FullName, Relationship and DOB
Then Input Beneficiaries for First Protect Spouse Primary Beneficiary FullName, Relationship and DOB
And Input Beneficiaries for First Protect Spouse Contingent Beneficiary FullName, Relationship and DOB

Then Confirmation page select Email Summary enter Email address
And Enter Credit Card Number and Expiration Date and CVV
And Select Singing Via Email and input Email address
Then Click Submit and Send Email for Signature

And Open Email account to Login Email Username and Password
Then Select Inbox and check Emails
And Select Email and click Review Application on AFBA Enrollment  
